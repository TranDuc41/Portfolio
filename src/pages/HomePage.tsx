...
function App() {
  ...
  const socials = [
    {
      title: "Github",
      link: "https://github.com/TranDuc41",
      icon: "./github-dark.svg",
    },
    {
      title: "Linkedin",
      link: "https://www.linkedin.com/in/tyduc/",
      icon: "./linkedin.svg",
    },
  ...
  const { ref: personalProjectsRef, inView: personalProjectsInView } =
    useInView();
        ...
        <div className="min-h-screen max-w-screen-2xl w-full flex flex-col mx-auto px-4 sm:px-8 md:px-12 lg:px-12 xl:px-24 py-12 md:py-20 lg:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-5 p-4 lg:h-screen lg:sticky top-0 flex flex-col gap-4 lg:w-11/12 lg:pt-12 lg:pb-6 overflow-y-auto scroll-smooth-thin">
              ...
              <div>
                <a
                  ...
                  target="_blank"
                  className="relative inline-flex items-center justify-center overflow-hidden rounded-lg bg-linear-to-r from-green-400 to-green-600 text-white focus:ring-0 focus:outline-none shadow-lg shadow-green-500/50"
                >
                  <span className="font-normal relative px-6 py-3 text-white">
                    My Resume
                  </span>
                </a>
              </div>
              ...
              <div>
                <span className="text-white/50">
                  Designed & Developed by Tran Duc
                </span>
              </div>
            </div>
            <div className="lg:col-span-7 py-8 max-lg:pb-20 overflow-y-auto">
              ...
              <div ref={personalProjectsRef} id="personal-projects">
                <SideProjectsSection />
              </div>
            </div>
          </div>
