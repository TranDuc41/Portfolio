const projects = [
  {
    title: "Hà Tĩnh Local",
    url: "https://hatinhlocal.vn",
    img_url: "./screencapture-hatinhlocal.jpg",
    short_desc:
      "A tourism and local business discovery platform that helps users explore destinations, accommodations, restaurants, and services across Hà Tĩnh.",
    team_size: "1 member",
    list_dsc: [
      {
        desc: "Designed and developed a full-stack tourism platform using Next.js, Payload CMS, and PostgreSQL.",
      },
      {
        desc: "Built business listings, destination management, and content publishing workflows.",
      },
      {
        desc: "Implemented SEO optimization, structured data, dynamic sitemap generation, and performance enhancements.",
      },
      {
        desc: "Deployed and maintained the platform using Docker, Cloudflare R2, and CI/CD pipelines.",
      },
    ],
  },
  {
    ...
    short_desc:
      "Build a website to sell fruit and introduce the company using Wordpress.",
    team_size: "1 member",
    list_dsc: [
      {
  ...
  },
  {
    ...
    short_desc:
      "Build LadingPage Ood with WordPress drag and drop based on Figma design.",
    team_size: "1 member",
    list_dsc: [
      {
        desc: "Website interface design",
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="mb-2 flex gap-3">
                      <a
                        href={project.url}
                        target="_blank"
                        className="text-xl leading-7 font-medium text-primary-500 w-auto"
                      >
                        {project.title}
                      </a>
                      <img
