const projects = [
  {
    ...
    short_desc:
      "A shoe-selling website built with Laravel, Inertia, and React. I created this website to learn and apply new knowledge. Due to limited time, the website is still under development, and I will update it whenever I have free time.",
  ...
  {
    title: "Movie App",
    url: "https://tranduc-movies.vercel.app/",
    git_url: "https://github.com/TranDuc41/movie-nextjs",
    short_desc:
      "An online movie streaming website using a third-party API, built with Next.js and some libraries for the frontend.",
    goal: "Create a website that is compatible across multiple devices and optimized for speed and user experience.",
    list_features: [
      {
  ...
  },
  {
    ...
    short_desc:
      "A responsive portfolio website built with React and Tailwind CSS, showcasing my projects and skills. Designed to deliver a smooth user experience on both desktop and mobile devices.",
            ...
            <div key={index} className="flex flex-col gap-5 md:p-6 li-glass">
              <div className="flex items-center gap-6">
                <a
                  href={project.url}
                  target="_blank"
                  className="flex gap-2 items-center text-xl leading-7 font-medium text-primary-500 w-auto"
                >
                  <h4>{project.title}</h4>
                  <img
